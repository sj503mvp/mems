...
export default {
    ...
    methods: {
        ...
        getProcessApproved: debounce(async function(params) {
            this.loading = true;
        ...
        initData() {
            if(Object.keys(this.$route.query).length == 0) {
                ...
                this.getProcessApproved(params);
            }
        },
        /**
         * 请求接口并存路由
         ...
         */
         async dealPageOrPageSize(params) {
            ...
            res = await $api.getProcessApproved(JSON.stringify(params));
